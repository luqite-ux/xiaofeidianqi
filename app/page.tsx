...
export default function HomePage() {
  return (
    <>
      <Hero />
      <SectionShell eyebrow="Product Systems" title="Electronic control solutions for intelligent appliances" text="Organized around application systems, not retail appliance sales. Each path leads buyers toward project requirements and technical discussion.">
        <ProductMatrix />
      </SectionShell>
      ...
      <SectionShell eyebrow="Quality & Testing" title="Clear inspection language for global B2B buyers">
        <QualityPreview />
      </SectionShell>
